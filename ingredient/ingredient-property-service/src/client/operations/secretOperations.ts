...
export class SecretOperations {
  ...
  deleteMethod(version: string, id: string, name: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<string>, callback?: msRest.ServiceCallback<string>): Promise<Models.SecretOperationsDeleteMethodResponse> {
    return this.client.sendOperationRequest(
      {
        version,
        id,
   ...
   */
  search(selectorFilterType: number, options?: Models.SecretOperationsSearchOptionalParams): Promise<Models.SecretOperationsSearchResponse>;
  /**
   * @param selectorFilterType
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  search(selectorFilterType: number, options: Models.SecretOperationsSearchOptionalParams, callback: msRest.ServiceCallback<any>): void;
  search(selectorFilterType: number, options?: Models.SecretOperationsSearchOptionalParams | msRest.ServiceCallback<any>, callback?: msRest.ServiceCallback<any>): Promise<Models.SecretOperationsSearchResponse> {
    return this.client.sendOperationRequest(
      {
        selectorFilterType,
        options
