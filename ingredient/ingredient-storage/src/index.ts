...
const { StoragePlugIn } = require('./plugin');
const { StorageUtils } = require('./functions');
...
exports.functionsNS = 'storage'; // bake.yaml expressions can access your functions via "myutils.my_function()"
